...
public actor ModelContainer {
    ...
    public func performLegacy<R>(_ action: @Sendable (any LanguageModel, Tokenizers.Tokenizer) throws -> R) rethrows
        -> R
    {
    ...
    public func performLegacy<V, R>(
        values: V, _ action: @Sendable (any LanguageModel, Tokenizers.Tokenizer, V) throws -> R
    ) rethrows -> R {
