...
open class ProcessorTypeRegistry: @unchecked Sendable {
    ...
    public init(creators: [String: @Sendable (URL, any Tokenizers.Tokenizer) throws -> any UserInputProcessor])
    {
    ...
    private var creators: [String: @Sendable (URL, any Tokenizers.Tokenizer) throws -> any UserInputProcessor]
    ...
    public func createModel(configuration: URL, processorType: String, tokenizer: any Tokenizers.Tokenizer)
        throws -> any UserInputProcessor
    {
