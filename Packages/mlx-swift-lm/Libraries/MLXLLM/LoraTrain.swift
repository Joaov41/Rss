...
struct LoRABatchIterator: Sequence, IteratorProtocol {
    ...
    public init(dataset: [String], tokenizer: Tokenizers.Tokenizer, batchSize: Int, train: Bool) {
...
public enum LoRATrain {
    ...
    public static func evaluate(
        model: Module, dataset: [String], loss: LoraLossFunction = loss, tokenizer: Tokenizers.Tokenizer,
    ...
    public static func train(
        ...
        loss: @escaping LoraLossFunction = loss, tokenizer: Tokenizers.Tokenizer, parameters: Parameters,
