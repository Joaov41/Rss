...
public final class Device: @unchecked Sendable, Equatable {
    ...
    private static let taskDefaultDeviceScope = ScopedValue<Device>(
        default: { _resolveGlobalDefaultDevice() })
    ...
    static public func defaultDevice() -> Device {
        taskDefaultDeviceScope.current
    }
    ...
    static public func withDefaultDevice<R>(
        ...
        try taskDefaultDeviceScope.withValue(device, operation: body)
    }
    ...
    static public func withDefaultDevice<R>(
        ...
        try await taskDefaultDeviceScope.withValue(device, operation: body)
    }

    /// Return the current default stream.
    static func defaultStream() -> Stream {
        taskDefaultDeviceScope.current.defaultStream
    }
