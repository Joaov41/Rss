...
#if os(iOS)
private struct WebAIHandoffRestoreGlassModifier: ViewModifier {
    @ViewBuilder
...
struct WebAIHandoffIOSPresenterModifier: ViewModifier {
    ...
    private func restoreButton(for request: WebAIHandoffRequest) -> some View {
        Button {
            ...
            .padding(.vertical, 10)
            .modifier(WebAIHandoffRestoreGlassModifier())
        }
        .buttonStyle(.plain)
...
private extension WebAIHandoffRepresentable {
    ...
    final class Coordinator: NSObject, WKNavigationDelegate, WKScriptMessageHandler, WKUIDelegate {
        ...
        private func triggerManualFallback() {
            deliverCaptureFailure("Auto-send could not find a usable message box after waiting for \(parent.request.provider.displayName).")
        }
