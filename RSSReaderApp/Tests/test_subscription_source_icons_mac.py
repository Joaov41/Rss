...
class MacSubscriptionSourceIconTests(unittest.TestCase):
    ...
    def test_mac_uses_existing_async_image_pipeline_without_persistence_changes(self):
        self.assertIn("private struct SidebarRemoteArtworkView", CONTENT_VIEW)
        self.assertIn("AsyncImage(url: artworkURL)", CONTENT_VIEW)
