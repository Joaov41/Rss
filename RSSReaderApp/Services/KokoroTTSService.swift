...
final class KokoroTTSService {
    ...
    /// Cold playback gets a longer bounded preparation window; warm playback
    /// keeps the existing short timeout.
    ...
    /// Indicates that shared model initialization is currently in flight.
